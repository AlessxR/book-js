...
export class Card extends DivComponent {
    ...
    render() {
            ...
            <div class="card__info">
                ...
                <div class="card__author">
                 ...
                 <div class="card__footer">
                    <button class="button__add ${existInFavorites ? 'button__active' : ''}"> ${existInFavorites ? '<img src="/static/favorites.svg">' : '<img src="/static/favorite-white.svg">'} </button>
                </div>
        ...
        if (existInFavorites) {
            this.element.querySelector('button').addEventListener('click', this.#deleteFromFavorites.bind(this));
        } else {
            this.element.querySelector('button').addEventListener('click', this.#addToFavorites.bind(this));
        }
